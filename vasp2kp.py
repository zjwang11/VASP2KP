...
@author: Sheng Zhang, Institute of Physics, Chinese Academy of Science

the python script of VASP2KP
VASP->vasp_kp->vasp2kp.py
"""
...
# open input file
with open('vasp2kp.in', 'r') as file:
    input_list = []
...
if no_vasp_kp:
    ...
    result_kp, result_Zeeman = \
    get_std_kp_Zeeman(Symmetry, folder_path, order=order, gfactor=gfactor, print_flag=print_flag, log=log, acc=acc)
