...
# step 3: run this patch: bash vasp_FS.6.4-patch-1.0.1.sh
...
if [ -d "vasp_FS.6.4" ]; then
    echo "The file folder 'vasp_FS.6.4' already exists, if you continue the installation, this folder will be deleted. Do you want to continue? [y/n]"
    read flag
    while [ 0 ]; do
...
echo "vasp_FS source file is in the file folder vasp_FS.6.4, do you want to compile it right now? [y/n]"
...
echo "The path of vasp_FS: $current_path/vasp_ncl_FS (or $current_path/vasp_std_FS)"
